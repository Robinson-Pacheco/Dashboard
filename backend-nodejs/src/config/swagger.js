...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Business Intelligence API for University Admission Data',
      version: '1.0.0',
      description: 'API for processing and analyzing university admission test data',
      contact: {
        name: 'API Support',
    ...
    components: {
      ...
      schemas: {
        User: {
          type: 'object',
          required: ['username', 'password', 'email', 'names'],
          properties: {
            username: {
              type: 'string',
        ...
        AdmissionData: {
          ...
          properties: {
            ...
            scores: {
              type: 'object',
              description: 'Object containing scores for different test subjects',
            ...
            totalScore: {
              type: 'number',
              description: 'Total score across all subjects',
            },
            status: {
              type: 'string',
              enum: ['pending', 'approved', 'rejected'],
              description: 'Admission status based on scores',
            },
            uploadedBy: {
              type: 'string',
              description: 'ID of the user who uploaded this data',
            },
            createdAt: {
              type: 'string',
              format: 'date-time',
        ...
        AdmissionStats: {
          ...
          properties: {
            ...
            approvedCount: {
              type: 'number',
              description: 'Number of students who were approved',
            },
            rejectedCount: {
              type: 'number',
              description: 'Number of students who were rejected',
            },
            pendingCount: {
              type: 'number',
              description: 'Number of students with pending status',
            },
          },
        },
        Error: {
        ...
        DisabilityStatistics: {
          ...
          properties: {
            ...
            withoutDisability: {
              type: 'number',
              description: 'Number of students without disabilities',
            },
            disabilityTypes: {
              type: 'object',
              properties: {
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/AdmissionStats' },
              },
            },
          },
          401: {
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/AdmissionTrends' },
              },
            },
          },
          401: {
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/DemographicBreakdown' },
              },
            },
          },
          401: {
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ComponentPerformance' },
              },
            },
          },
          401: {
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/DisabilityStatistics' },
              },
            },
          },
          401: {
